...
### Local System Diagrams (DSD & ERD)

Since we chose to implement the integration using Method B (Foreign Tables), there is no need for structural changes or reverse engineering, and the databases remain exactly as they are. The integration process focuses entirely on creating a virtual "bridge" between the two systems.

Therefore, the original Relational Schema Diagram (DSD) and Entity-Relationship Diagram (ERD) of our local system remain unchanged:

**Relational Schema Diagram (DSD):** ![Relational Schema Diagram](./images/relational_schema.png)

**Entity-Relationship Diagram (ERD):** ![Entity-Relationship Diagram](./images/erd.png)
